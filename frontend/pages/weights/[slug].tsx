        ...
        <div className="container mt-10 md:mt-20">
            <div className="grid grid-cols-[120px_1fr] md:grid-cols-[250px_1fr] items-center lg:grid-cols-2">
                ...
                <div className="lg:col-start-1 lg:col-end-3 pl-5 lg:pl-0 md:mt-5">
                    <a target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-700 text-lg sm:text-2xl md:mb-2" href={`https://www.google.com/search?q=${item.title}`}>
                        {item.title}
                ...
                <div className="flex flex-col self-start col-start-1 col-end-3 lg:row-start-2 mt-5 lg:mt-0">
                    <a target="_blank" rel="noopener noreferrer" href="https://de.wikipedia.org/wiki/Korrelationskoeffizient" className="text-gray-600 hover:text-gray-700 mb-3">According to $source a {item.title} weights $130.000 - 150.000 kg.</a>
