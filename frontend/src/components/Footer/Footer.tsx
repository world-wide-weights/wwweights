...
import discord from "../../assets/images/social_logos/discord/logo_icon.svg"
import github from "../../assets/images/social_logos/github/logo_icon.svg"
import twitter from "../../assets/images/social_logos/twitter/logo_icon.svg"
				...
				<div className="flex flex-col lg:flex-row justify-between mb-4 lg:mb-0">
					<div className="md:w-2/3 lg:w-1/3 mb-4">
						...
						<p className="text-gray-700 text-sm md:text-base mb-2">
							World&apos;s largest database of weights! World Wide Weights is a community project to create a global database of weights.
						</p>
					...
					<div className="mb-4">
						<Headline className="text-gray-900" level={4} hasMargin={false}>
							Links
						</Headline>
					...
					<div className="mb-4">
						...
						<ul className="text-sm md:text-base ">
							...
							<li>
								<Button to={routes.tags.list()} kind="tertiary">
									All tags
								</Button>
							</li>
						</ul>
					...
					<div className="mb-4">
						...
						<ul className="text-sm md:text-base ">
							<li>
								<Button to={routes.misc.index} kind="tertiary">
									Help Center
								</Button>
							</li>
							<li>
								<Button to={routes.misc.contact} kind="tertiary">
									Contact Us
								</Button>
							</li>
							<li>
								<Button to={routes.misc.privacy} kind="tertiary">
									Privacy Policy
								</Button>
							</li>
							<li>
								<Button to={routes.misc.terms} kind="tertiary">
