	...
	return (
		<>
			<div className="lg:flex h-screen">
				...
				<div
					style={{ backgroundImage: `url(${backgroundHalfPage.src})` }}
					className="hidden lg:flex items-center justify-center bg-[url(${backgroundHalfPage.src)] bg-no-repeat bg-cover bg-center w-1/2"
				>
