    ...
    return <>
        ...
        <ul className="mb-5 md:mb-10">
            {relatedItemsWithItemSorted.map(relatedItem => {
                ...
                return <ItemPreviewList key={relatedItem.id} selectedItem={currentItem} disableLink={currentItem} difference={difference} {...relatedItem} heaviestWeight={heaviestWeight} imageUrl="https://picsum.photos/200" />
            })}
        </ul>
    </>
}