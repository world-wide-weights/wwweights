...
export const Tooltip: React.FC<TooltipProps> = ({ children, content, delay, wrapperClassname = "", position = "top", customMargin = "-40px" }) => {
	...
	// CSS Classes
	const baseClass = "absolute bg-blue-900 text-white text-sm rounded-md left-1/2 -translate-x-1/2 whitespace-nowrap z-50 px-4 py-2"
	...
	const tooltipClassesPosition = {
		["top"]: "text-center before:top-full before:border-t-blue-900",
		["right"]:
			"left-[calc(100%_+_20px)] top-1/2 translate-x-0 -translate-y-1/2 before:left-[-8px] before:top-1/2 before:translate-x-0 before:-translate-y-1/2 before:border-r-blue-900",
		["bottom"]: "text-center before:bottom-full before:border-b-blue-900",
		["left"]:
			"left-auto right-[calc(100%_+_20px)] top-1/2 translate-x-0 -translate-y-1/2 before:left-auto before:right-[-16px] before:top-1/2 before:translate-x-0 before:-translate-y-1/2 before:border-l-blue-900",
	}
