    ...
    return <main datacy="skeleton-loading" className="container mt-5">
        ...
        <div className="lg:flex gap-4">
            <div className="sm:flex lg:flex-col gap-3 2xl:w-1/4 mb-6 lg:mb-0">
                ...
                <div className="flex flex-col gap-3 flex-grow">
                    {new Array(4).fill(0).map((_, index) =>
                        <div key={index} className="flex items-center bg-slate-200 animate-pulse h-20 rounded-lg mb-2">
                            <div className="bg-slate-300 animate-pulse h-14 w-14 rounded-full ml-7 mr-4"></div>
                            <div>
                                <div className="bg-slate-300 animate-pulse h-4 w-24 mb-2"></div>
            ...
            <div className="lg:w-3/4">
                ...
                <ul className="mb-10">
                    {new Array(6).fill(0).map((_, index) => <li key={index} className="bg-slate-200 animate-pulse rounded-lg py-4 px-2 md:py-2 mb-2">
                        <div className="flex justify-between">
                            ...
                            <div className="flex justify-between md:justify-start items-center w-full md:h-12 mx-2 md:mx-4">
                                <div className="md:flex">
                                    <div className="bg-slate-300 animate-pulse h-5 w-28 md:w-60 pr-3 mr-4 mb-2 md:mb-0"></div>
                                    <div className="bg-slate-300 animate-pulse h-5 md:w-32 mr-5"></div>
                                </div>
                                <div className="bg-slate-300 animate-pulse h-14 w-14 rounded-lg"></div>
                            </div>

                            {/* Actions */}
                            <div className="flex items-center mx-0 sm:mx-3">
                                <div className="bg-slate-300 animate-pulse h-10 w-10 rounded-full mr-1 md:mr-3"></div>
                                <div className="bg-slate-300 animate-pulse h-10 w-10 rounded-full"></div>
                            </div>
                        </div>
                    </li>)}
                </ul>
