...
import discord from "../../assets/images/social_logos/discord/logo.svg"
import github from "../../assets/images/social_logos/github/logo.png"
import twitter from "../../assets/images/social_logos/twitter/logo.svg"
...
const Contact: NextPageCustomProps = () => {
	return (
		<>
			<Seo title="Contact Information for World Wide Weights" description="Contact us via email or social media!" />
...
Contact.layout = (page) => {
	return <PageLayout title="Contact">{page}</PageLayout>
}
