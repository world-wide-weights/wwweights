...
const Contact: NextPageCustomProps = () => {
    return <>
        ...
        <div className="flex">
            <a href="https://discord.gg/UmxWf2FEQx" className="mb-2 mr-2" target="_blank" title="Link to our discord server!" rel="noreferrer noopener">
                <Image height={40} alt="Image of Discord Logo" src={discord} />
            </a>
            <a href="https://github.com/world-wide-weights" className="mb-2 mr-2" target="_blank" title="Link to our GitHub Orga!" rel="noreferrer noopener">
                <Image height={40} alt="Image of GitHub Logo" src={github} />
            </a>
            <a href="https://twitter.com/wwweights" className="mb-2" target="_blank" title="Link to our Twitter!" rel="noreferrer noopener">
